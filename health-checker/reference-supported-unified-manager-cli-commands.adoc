...
`um svm list [-q] [ -ObjectType <object-id>]`
 a| 
Le répertorie les SVM après un filtrage sur l'objet spécifié. ObjectType peut être lun, qtree, cluster, volume, quota, ou svm. Par exemple : `um svm list -cluster 1`
