...
L'exemple ci-dessous montre comment créer des alertes pour le volume « vol1 » sur le SVM primaire « vs1 » , mais exclut la génération de l'alerte sur un volume portant le même nom sur le SVM « vs1-dr » .
...
+
Cela exclut l'alerte d'être générée pour le volume « vol1 » sur la SVM « vs1-dr » .
