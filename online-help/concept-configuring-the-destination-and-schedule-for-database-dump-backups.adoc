...
[NOTE]
====
Si vous constatez que le nombre de fichiers de sauvegarde incrémentielle est trop important pour l'espace que vous avez alloué aux sauvegardes, vous pouvez créer une nouvelle sauvegarde complète périodiquement pour remplacer l'ancienne sauvegarde complète et tous ses fichiers incrémentiels enfants.
